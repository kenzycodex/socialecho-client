...
const authReducer = (state = initialState, action) => {
  ...
  switch (type) {
    case types.SET_ACCESS_TOKEN:
      return {
        ...state,
        accessToken: payload ?? null,
      };

    case types.SET_REFRESH_TOKEN:
      return {
        ...state,
        refreshToken: payload ?? null,
      };
    ...
    case types.GET_CONTEXT_AUTH_DATA_FAIL:
      return {
        ...state,
        contextAuthData: null,
        contextAuthError: payload ?? null,
      };

    case types.GET_TRUSTED_AUTH_CONTEXT_DATA_SUCCESS:
      return {
        ...state,
        trustedAuthContextData: payload ?? [],
        contextAuthError: null,
      };
    ...
    case types.GET_BLOCKED_AUTH_CONTEXT_DATA_SUCCESS:
      return {
        ...state,
        blockedAuthContextData: payload ?? [],
        contextAuthError: null,
      };
